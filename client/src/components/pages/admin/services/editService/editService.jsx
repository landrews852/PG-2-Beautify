        ...
        <div className={s.new}>
          ...
          >
            ...
            {services?.map((service) => (
              <option
                value={service.id}
                selected={id ? service.id == id : false}
              >
                ...
                <div className={s.form}>
                  ...
                  <div hidden={true}>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                    >
                      <option value="false" selected={`${!input.disabled}`}>
                        activo
                      </option>
                      <option value="true" selected={`${input.disabled}`}>
                        desactivado
                      </option>
                    </select>
                    {errors.disabled && (
                      ...
                      {categories.map((category) => {
                        return (
                          <option
                            ...
                            key={category.id}
                            value={category.id}
                            selected={input.categoryId == category.id}
                          >
